...
class _ResNetDenseRefiner(_DenseBase):
    """
...
class ResNet18DenseRef(_ResNetDenseRefiner):

    def __init__(self, **kwargs):
        super().__init__(resnet18, **kwargs, small_resnet=True)


class ResNet34DenseRef(_ResNetDenseRefiner):

    def __init__(self, **kwargs):
        super().__init__(resnet34, **kwargs, small_resnet=True)


class ResNet50DenseRef(_ResNetDenseRefiner):

    def __init__(self, **kwargs):
        super().__init__(resnet50, **kwargs)


class ResNet101DenseRef(_ResNetDenseRefiner):

    def __init__(self, **kwargs):
        super().__init__(resnet101, **kwargs)


class ResNet152DenseRef(_ResNetDenseRefiner):
